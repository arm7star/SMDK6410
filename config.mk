...
CPPFLAGS += -I$(TOPDIR)/include -I$(TOPDIR)/ucos3
CPPFLAGS += -fno-builtin -ffreestanding -nostdinc -Wno-implicit-function-declaration -Wno-unused-variable -Wno-unused-function \
	-isystem $(gccincdir) -pipe $(PLATFORM_CPPFLAGS) -Wno-unused-but-set-variable

ifdef BUILD_TAG
CFLAGS := $(CPPFLAGS) -Wall -Wstrict-prototypes \
	-DBUILD_TAG='"$(BUILD_TAG)"'
else
CFLAGS := $(CPPFLAGS) -Wall -Wstrict-prototypes -Wno-return-type
endif
